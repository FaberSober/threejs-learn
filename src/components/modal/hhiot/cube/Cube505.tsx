...
export function Cube505({ ...props }: CubeProps) {
  ...
  return (
    <group name="505" {...props} dispose={null}>
      <group
        ref={targetRef}
        name="Mesh505"
        position={[14.906, 3.156, -61.843]}
        onPointerOver={onPointerOver}
        onPointerOut={onPointerOut}
      >
        <mesh name="Mesh505" geometry={nodes.Mesh505.geometry} material={meshMaterial} />

        {/* 指示牌 */}

          <Indicator targetRef={targetRef} visible={hovered} name='505' orientPos={[0,0,-30]}>
            <CubeInfoCard
              no='505'
              name='③联C40砼上涵首墙身及顶板'
              status='已浇筑'
        ...
        <BimText3D text="505" width={6} position={[12.3, -2, -2]} rotation={[0, Math.PI / 2, 0]} />
        <BimText3D text="505" width={6} position={[12.3, -2, -9]} rotation={[0, Math.PI / 1, 0]} />
      </group>
    </group>
  )
}
