...
let scene: THREE.Scene, renderer: THREE.WebGLRenderer, camera: THREE.PerspectiveCamera, stats: any;
...
export default function DemoTwo12() {
  ...
  function main() {
    ...
    loader.load('/assets/model/Xbot.glb', function (gltf: GLTF) {
  ...
  return (
    <div>
      ...
      <div id="container" style={{width: 700, height: 500}}></div>
      <div id="info">
